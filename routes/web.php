...
Route::post('/updatehud','CarController@updatehud');
Route::post('/updatetos','CarController@updatetos');
...
Route::get('/searchproduct', 'CarController@searchproduct')->name('searchproduct');
